<h2><a href="https://leetcode.com/problems/determine-if-two-strings-are-close/">1657. Determine if Two Strings Are Close</a></h2><h3>Medium</h3><hr><div><p>Two strings are considered <strong>close</strong> if you can <font _mstmutation="1" _msthash="20488" _msttexthash="79248">attain</font> one from the other using the following operations:</p>
