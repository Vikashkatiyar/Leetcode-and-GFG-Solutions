...
<div class="problem-statement">
                <p></p><p><span style="font-size:18px">Given a string consisting of lowercase english alphabets. Find the repeated character present <strong>first</strong> in the string.</span></p>
